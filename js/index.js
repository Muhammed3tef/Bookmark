...
function addData(){
    var databook={
        code: inputName.value , link: inputURL.value
    }
...
function readData(){
    ...
    for(var i=0 ;i<bookmarkData.length ;i++){
        ...
        <td class="p-3"><button  class="btn btn-warning px-4 fw-semibold"><i class="fa-solid fa-eye"></i>  <a href="${bookmarkData[i].link}" target="_blank">Visit</a></button></td>
